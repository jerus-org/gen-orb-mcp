...
- MVP: 6-8 weeks → 15-20 weeks
- Enhanced: 8-10 weeks → 20-25 weeks
...
├── crates/
│   └── gen-orb-mcp/               # Single crate (for now)
...
│       ├── CHANGELOG.md            # Generated by gen-changelog
│       ├── LICENSE-APACHE
│       ├── LICENSE-MIT
│       ├── release.toml            # Crate release config
│       └── release-hook.sh         # CHANGELOG generator
├── tests/                          # Shared integration tests
├── PRLOG.md                        # Workspace PR log
├── README.md                       # Workspace README
├── CONTRIBUTING.md
├── CODE_OF_CONDUCT.md
├── SECURITY.md
├── rustfmt.toml
├── release.toml                    # Workspace release config
├── deny.toml                       # cargo-deny audit
...
✅ Parse any CircleCI orb YAML  
✅ Generate MCP server (single version)  
✅ Binary deployment (Linux x86_64 only)  
✅ Private registry support (Docker Hub + private)  
✅ CLI interface  
✅ Basic resources (commands, jobs, executors)  
✅ CircleCI integration with circleci-toolkit  
✅ Workspace structure per CLAUDE.md  
✅ Proper release.toml configuration  
✅ CHANGELOG.md generation via gen-changelog  
✅ PRLOG.md tracking  
✅ Name reservation on crates.io  
...
- ✅ Successfully generates MCP server for any orb
- ✅ Private registry deployment working
