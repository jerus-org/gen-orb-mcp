...
- deps: update dependency gen-circleci-orb to v0.1.25(pr [#316])
- deps: update dependency gen-orb-mcp to v0.2.5(pr [#317])
...
- deps: update dependency toolkit to v7.4.0(pr [#306])
- deps: update dependency gen-circleci-orb to v0.1.19(pr [#301])
- deps: update rust:1-slim-trixie docker digest to bce1476(pr [#300])
- deps: update rust crate clap to 4.6.7(pr [#302])
- deps: update rust crate pcu to 0.6.34(pr [#303])
- deps: update rust crate pmcp to 2.20.0(pr [#304])
- deps: update dependency orb-tools to v12.5.0(pr [#305])
...
- deps: update dependency toolkit to v7(pr [#267])
- deps: lock file maintenance(pr [#269])
- deps: update rust crate pcu to 0.6.33(pr [#271])
- deps: update dependency toolkit to v7.2.0(pr [#272])
- drop unused mut in generated tools vec(pr [#284])
...
- run set_https_remote after fetch, not before(pr [#265])
...
- deps: update rust crate clap to 4.6.4(pr [#261])
- deps: update rust crate tokio to 1.53.1(pr [#263])
- deps: update rust crate trycmd to 1.2.1(pr [#264])
...
[#261]: https://github.com/jerus-org/gen-orb-mcp/pull/261
[#263]: https://github.com/jerus-org/gen-orb-mcp/pull/263
[#264]: https://github.com/jerus-org/gen-orb-mcp/pull/264
[#265]: https://github.com/jerus-org/gen-orb-mcp/pull/265
[#268]: https://github.com/jerus-org/gen-orb-mcp/pull/268
[#267]: https://github.com/jerus-org/gen-orb-mcp/pull/267
...
[#284]: https://github.com/jerus-org/gen-orb-mcp/pull/284
...
[#306]: https://github.com/jerus-org/gen-orb-mcp/pull/306
[#301]: https://github.com/jerus-org/gen-orb-mcp/pull/301
[#300]: https://github.com/jerus-org/gen-orb-mcp/pull/300
[#302]: https://github.com/jerus-org/gen-orb-mcp/pull/302
[#303]: https://github.com/jerus-org/gen-orb-mcp/pull/303
[#304]: https://github.com/jerus-org/gen-orb-mcp/pull/304
...
[#316]: https://github.com/jerus-org/gen-orb-mcp/pull/316
[#317]: https://github.com/jerus-org/gen-orb-mcp/pull/317
